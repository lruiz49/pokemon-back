...
import { CreatePokemonDto, UpdatePokemonDto, PokemonDto } from 'src/pokemon/dto/pokemon.dto';
...
describe('DTO validation with ValidationPipe', () => {
    ...
    it('(CreatePokemonDto) accepts a valid body and coerces numbers', async () => {
        ...
        const result = await pipe.transform(body, meta(CreatePokemonDto)) as CreatePokemonDto;
    ...
    it('(CreatePokemonDto) rejects unknown fields (forbidNonWhitelisted)', async () => {
        ...
        await expect(pipe.transform(body, meta(CreatePokemonDto))).rejects.toBeInstanceOf(BadRequestException);
    });
    ...
    it('(UpdatePokemonDto) allows partials (no required fields)', async () => {
        ...
        const result = await pipe.transform(body, meta(UpdatePokemonDto)) as UpdatePokemonDto;
    ...
    it('(PokemonDto) rejects missing required fields', async () => {
        ...
        await expect(pipe.transform(body, meta(PokemonDto))).rejects.toBeInstanceOf(BadRequestException);
    });
});